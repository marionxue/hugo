...
### <span id="inline-toc">2.</span>1 生产环境配置direct-lvm模式
...
<center>![](http://ycs.ylck.me/devicemapper-in-practice-pic4.jpg)</center>
...
### <span id="inline-toc">3.</span>1 监控 thin pool
...
### <span id="inline-toc">3.</span>2 为正在运行的设备增加容量
...
### <span id="inline-toc">4.</span>1 磁盘上的镜像和容器层
...
### <span id="inline-toc">4.</span>2 镜像分层与共享
...
<center>![](http://ycs.ylck.me/devicemapper-in-practice-pic1.jpg)</center>
...
<center>![](http://ycs.ylck.me/devicemapper-in-practice-pic2.jpg)</center>

## <span id="inline-toc">5.</span> devicemapper 读写数据的过程
------

### <span id="inline-toc">5.</span>1 读数据

我们来看下使用 `devicemapper` 存储驱动如何进行读文件。下图显示在示例容器中读取一个单独的块 [0x44f] 的过程。

<center>![](http://ycs.ylck.me/devicemapper-in-practice-pic3.jpg)</center>
...
### <span id="inline-toc">5.</span>2 写数据
...
### <span id="inline-toc">6.</span>1 按需分配对性能的影响
...
### <span id="inline-toc">6.</span>2 写时拷贝对性能的影响
...
### <span id="inline-toc">6.</span>3 其他注意事项
